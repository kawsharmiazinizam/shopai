...
export default function Home() {
  ...
  const catEmojis = { Electronics: '📱', Fashion: '👗', 'Home & Garden': '🏡', Sports: '⚽', Books: '📚', Beauty: '💄' };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 rounded-2xl p-10 mb-10 text-white text-center relative overflow-hidden">
        ...
        <h1 className="text-4xl font-bold mb-3 relative">⚡ ShopAI Store</h1>
        <p className="text-lg opacity-90 relative">Smart shopping powered by AI — find the best products instantly</p>
        <div className="flex flex-wrap justify-center gap-4 mt-6 relative">
          <span className="bg-white/20 backdrop-blur px-4 py-1.5 rounded-full text-sm font-medium">🤖 AI Chatbot</span>
          <span className="bg-white/20 backdrop-blur px-4 py-1.5 rounded-full text-sm font-medium">✨ Smart Search</span>
          <span className="bg-white/20 backdrop-blur px-4 py-1.5 rounded-full text-sm font-medium">❤️ Wishlist</span>
          <span className="bg-white/20 backdrop-blur px-4 py-1.5 rounded-full text-sm font-medium">📦 Fast Delivery</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSearch} className="flex gap-3 mb-6">
        <input
          ...
          placeholder="🔍 Search products... (e.g. iPhone, Nike, Book)"
